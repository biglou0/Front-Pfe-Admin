            ...
            <div className="top">
              <div className="left">
                ...
                <div className="item">
                  ...
                  <h1 className="itemTitle">N° Réclamation : {user && user.NumRec}</h1>
                    ...
                    <div className="detailItem">
                      <span className="itemKey">Phone Du Réclameur:</span>
                    ...
                    <div className="detailItem">
                      <span className="itemKey">Role Du Réclameur:</span>
